...
export const categories = [
  { id: 'frameworks', name: 'Frameworks', icon: 'Layers', description: 'Core frameworks to build your app' },
  { id: 'ui', name: 'UI Libraries', icon: 'Palette', description: 'Beautiful component libraries' },
  { id: 'state', name: 'State Management', icon: 'Database', description: 'Manage your app state' },
  { id: 'animation', name: 'Animations', icon: 'Sparkles', description: 'Bring your UI to life' },
  { id: 'auth', name: 'Authentication', icon: 'Shield', description: 'Secure your application' },
  { id: 'devtools', name: 'Dev Tools', icon: 'Wrench', description: 'Improve your DX' },
  { id: 'utilities', name: 'Utilities', icon: 'Package', description: 'Helpful utility libraries' },
];
...
export const presets: Preset[] = [
  ...
  },
  {
    ...
    tools: ['nextjs', 'tailwind', 'shadcn', 'zustand', 'tanstack-query', 'nextauth', 'typescript', 'zod'],
    icon: '🚀',
  },
  {
    id: 'minimal-react',
